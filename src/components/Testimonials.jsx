...
const testimonials = [
  {
    ...
    photo: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?ixlib=rb-4.0.3&auto=format&fit=crop&w=160&h=160&q=85',
    stars: 5,
  },
  {
    name: 'Antoine V.',
    ...
    photo: 'https://images.unsplash.com/photo-1560250097-0b93528c311a?ixlib=rb-4.0.3&auto=format&fit=crop&w=160&h=160&q=85',
    stars: 5,
  },
  {
    name: 'Sophie L.',
    ...
    photo: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?ixlib=rb-4.0.3&auto=format&fit=crop&w=160&h=160&q=85',
    stars: 5,
  },
  {
    name: 'Karim B.',
    ...
    photo: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-4.0.3&auto=format&fit=crop&w=160&h=160&q=85',
    stars: 5,
  },
  {
    name: 'Céline R.',
    ...
    photo: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?ixlib=rb-4.0.3&auto=format&fit=crop&w=160&h=160&q=85',
    stars: 5,
  },
  {
    name: 'TechSolutions SAS (Marc D.)',
    category: 'Entreprise (Directeur Financier)',
    quote: 'Notre PME a obtenu un remboursement de TVA conséquent grâce à EuroTax. Professionnels et réactifs.',
    photo: 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?ixlib=rb-4.0.3&auto=format&fit=crop&w=160&h=160&q=85',
    stars: 5,
  },
]
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center max-w-3xl mx-auto mb-20 animate-fadeInUp">
          ...
          <h2 className="font-sora text-4xl md:text-5xl font-extrabold text-slate-900 mb-6 tracking-tight leading-tight">
            Avis clients : ils ont obtenu leur <span className="text-brand-600">remboursement d'impôt</span>
          </h2>
          <p className="text-lg text-slate-500 leading-relaxed font-medium">
            Découvrez les retours d'expérience de particuliers, expatriés et entreprises.
          </p>
        </div>
            ...
            >
              ...
              <div className="flex items-center gap-4 mb-8 relative z-10">
                ...
                <div>
                  ...
                  <p className="font-sora text-sm font-bold text-slate-900 tracking-tight">{t.name}</p>
