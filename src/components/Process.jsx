...
const STEPS = [
  {
    ...
    title: '1. Dépôt de votre demande en ligne',
    desc: 'Renseignez vos informations fiscales en quelques minutes via notre formulaire sécurisé.',
  },
  {
    num: '02',
    icon: <IconSearch size={22} />,
    title: '2. Analyse de votre situation fiscale et estimation',
    desc: 'Nos experts étudient votre dossier et identifient les montants et crédits d\'impôt récupérables.',
  },
  {
    num: '03',
    icon: <IconUpload size={22} />,
    title: '3. Préparation et traitement de votre dossier',
    desc: 'Nous préparons l\'ensemble des éléments justificatifs et assurons le traitement de votre demande.',
  },
  {
    num: '04',
    icon: <IconMoney size={22} />,
    title: '4. Réception de votre remboursement',
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          <h2 className="font-sora text-4xl md:text-5xl font-extrabold text-slate-900 mb-6 tracking-tight leading-tight">
            Comment obtenir votre <span className="text-brand-600">remboursement d'impôt</span> en 4 étapes
          </h2>
          <p className="text-lg text-slate-500 leading-relaxed">
            De votre premier clic au remboursement, nous vous accompagnons à chaque étape en toute transparence.
          </p>
        </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 relative z-10">
            {STEPS.map((step, i) => (
              <div className="flex flex-col items-center text-center group" key={i}>
                ...
                <h3 className="font-sora text-lg font-bold text-slate-900 mb-3 tracking-tight group-hover:text-brand-700 transition-colors">
                  {step.title}
                </h3>
