      ...
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center relative z-10 w-full">
        ...
        <div className="animate-fadeInUp">
          ...
          <p className="text-lg text-slate-500 leading-relaxed mb-10 max-w-2xl font-medium">
            EuroTax Refund vous aide à obtenir la récupération de vos impôts et trop-perçus fiscaux. Particuliers, salariés, expatriés et entreprises : bénéficiez d'une analyse gratuite de votre situation en 24h.
            <br />
            <span className="text-brand-600 font-bold">Sans frais si nous n'obtenons aucun remboursement.</span>
          </p>
