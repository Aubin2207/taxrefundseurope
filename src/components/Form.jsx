  ...
  '@graph': [
    {
      ...
      'name': 'Demande de remboursement fiscal | EuroTax Refund',
      'description': "Déposez votre demande de remboursement fiscal en quelques minutes. Analyse gratuite de votre dossier par nos experts. Sans frais si nous n'obtenons rien — EuroTax Refund.",
      'isPartOf': {
    ...
    {
      '@type': 'BreadcrumbList',
      '@id': 'https://taxrefundseurope.netlify.app/form#breadcrumb',
      'itemListElement': [
        {
          '@type': 'ListItem',
          'position': 1,
        ...
        },
        {
          '@type': 'ListItem',
          'position': 2,
          'name': 'Demande de remboursement fiscal',
          'item': 'https://taxrefundseurope.netlify.app/form'
        }
      ]
    }
  ]
...
export default function FormPage() {
  usePageSEO({
    title: 'Demande de remboursement fiscal | EuroTax Refund',
    description: 'Déposez votre demande de remboursement fiscal en quelques minutes. Analyse gratuite de votre dossier par nos experts. Sans frais si nous n\'obtenons rien — EuroTax Refund.',
    canonicalPath: '/form',
    schema: FORM_SCHEMA
  })
